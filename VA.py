...
def main():
    with sr.Microphone() as source:
        ...
        try:
            ...
            print("Listening...") # to understand when the program(virtual assistant) is listening.
            ...
            if r.recognize_google(audio) == "hey Sarah" or "Hey sarah" or "Hey Sarah" or "hey sarah": # Trigger (What the Assistant answer to) // Also checks for trigger
                ...
                if r.recognize_google(audio) == "nevermind":
                    ...
                    bye = ["Bye...","see You Next Time...","Good Bye For Now..."]
                    random_bye = random.choice(bye)
                    engine.say(random_bye)
                    print("Sarah: OK, " + random_bye)
                    engine.runAndWait()
                    main()
                else:
                    print("You: "+r.recognize_google(audio))
